          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12">
                <img className="img-responsive" src={image01} />
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <p className="section-container-spacer">Auctor augue mauris augue neque. Posuere lorem ipsum dolor sit amet consectetur adipiscing. Porta
                ...
                <div className="row section-container-spacer">
                  <div className="col-md-6">
                    <img className="img-responsive" src={image03} />
                  </div>
                  <div className="col-md-6">
                    <img className="img-responsive" src={image02} />
                  </div>
                </div>
              </div>
              <div className="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <small className="signature pull-right">Team</small>
              </div>
            </div>
          </div>
        </div>
